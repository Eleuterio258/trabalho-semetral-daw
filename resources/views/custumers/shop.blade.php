<div class="container flex justify-between py-4">
    <div class="flex items-center gap-3">
        <a href="{{ route('home') }}" class="text-base text-primary">
...
<div class="container relative grid items-start gap-6 pt-4 pb-16 lg:grid-cols-4">
                ...
                <div class="space-y-2">
                    ...
                    @foreach ($categories as $category)
                        <div class="flex items-center">
                            ...
                            <label for="Bedroom"
                                class="ml-3 text-gray-600 cursor-pointer">{{ $category->name }}</label>
                            <div class="ml-auto text-sm text-gray-600">({{ $category->id }})</div>
                        </div>
                    @endforeach
                </div>
            </div>
                    ...
                    @foreach ($products as $product)
                        <div class="flex items-center">
                            <input type="checkbox" id="Dominik"
                                class="rounded-sm cursor-pointer text-primary focus:ring-0">
                            <label for="Dominik"
                                class="ml-3 text-gray-600 cursor-pointer">{{ $product->brand }}</label>
    ...
    <!-- products -->
    <div class="col-span-3 product_data">
        <!-- sorting -->
        ...
        <div class="grid gap-6 lg:grid-cols-2 xl:grid-cols-3 sm:grid-cols-2 ">
            ...
            @foreach ($products as $product)
                ...
                <div class="overflow-hidden bg-white rounded shadow group ">
                  ...
                  {{--   @if ($stock == 0)
                        <a href="#"
                            class="block w-full py-1 text-center text-white transition border rounded-b cursor-not-allowed bg-opacity-80 bg-primary border-primary hover:bg-transparent hover:text-primary addToCart">
                            Add to Cart
                        </a>
                    @else
                        <a href="#"
                            class="block w-full py-1 text-center text-white transition border rounded-b bg-primary border-primary hover:bg-transparent hover:text-primary addToCart">
                            Add to Cart
                        </a>
                    @endif  --}}
