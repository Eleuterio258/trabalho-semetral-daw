...
@section('dashboard-content')
    ...
    <form action="{{ URL::to('admin/post-category-form') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="image_url" onchange="loadPhoto(event)">
        </div>
